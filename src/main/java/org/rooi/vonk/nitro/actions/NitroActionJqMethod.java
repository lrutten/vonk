...
This class takes possibility 1.

 */

public class NitroActionJqMethod extends NitroActionJq
{
   private String[]     method;
   private String[]     args;
   private String       format;

   public NitroActionJqMethod(String targ, String[] meth, String[] rgs, String fmt)
   {
      super(targ);
      method = meth;
      args = rgs;
