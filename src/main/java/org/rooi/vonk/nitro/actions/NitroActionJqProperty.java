...
This class takes possibility 2 to 5.

 */

public class NitroActionJqProperty extends NitroActionJq
{
   private static Logger logger = LogManager.getLogger();
   private String       property;
   private NitroElement right;

   public NitroActionJqProperty(String targ, String prop, NitroElement el)
   {
      super(targ);
      property = prop;
      right    = el;
   ...
   {
      String result = String.format("%s.%s='%s';", NitroWfEvent.target(target), property, right.render(ni));
      logger.debug("NitroActionJqPropery.render " + result);
      return result;
   }
}
